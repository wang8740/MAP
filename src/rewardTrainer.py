...
if __name__ == "__main__":
    ...
    tokenizer = AutoTokenizer.from_pretrained(model_config.model_name_or_path, use_fast=True, max_length=reward_config.max_length)
    print('zzz', tokenizer.pad_token_id, tokenizer.eos_token_id)
