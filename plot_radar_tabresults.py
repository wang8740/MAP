...
'''
    This script converts the results in the main tables to radar charts for better visualization.
'''

# VERSION 1: Uniform color and marker
# def plot_radar_chart(categories, model_scores, title_text, output_file, model_name):
...
# VERSION 2: Various color and marker
def plot_radar_chart(categories, model_scores, title_text, output_file, model_name, art_set=0):
