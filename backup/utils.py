...
import json
import nltk
# nltk.download('punkt_tab') # run this one time only and figure out the path (maybe in terminal)
nltk.data.path.append('/Users/dingj/nltk_data') # on local mac
# nltk.data.path.append('/users/5/wang8740/nltk_data') # on MSI
